import { StyleSheet, Text, View, StatusBar,Image,TouchableOpacity, Vibration} from 'react-native'
...
<Text style={{fontFamily:'Roboto-Black',fontSize:25,color:'#fff',alignSelf:'center',textAlign:'center',fontWeight:'700'}} >Buy Bitcoin and Trade Top Cryptocurrency</Text>
